...
Program program = new Program();
    ...
    assertEquals("Должно вернуться false, тк пользователь несовершеннолетний", false, isAdult);
}
...
Program program = new Program();
    ...
    assertEquals("Должно вернуться true, тк пользователь несовершеннолетний", true, isAdult);
}
// Напиши код здесь
